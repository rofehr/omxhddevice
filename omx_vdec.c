...
#define OPEN_LINUX_STATISTICS (0)
...
OMX_ERRORTYPE omx_vdec::component_init(OMX_STRING name)
{
    ...
    else if(!strncmp((char*)m_cName, "OMX.allwinner.video.decoder.divx3", OMX_MAX_STRINGNAME_SIZE))
    {
        strncpy((char *)m_cRole, "video_decoder.divx3", OMX_MAX_STRINGNAME_SIZE);
        m_eCompressionFormat      = OMX_VIDEO_CodingDIVX3;
